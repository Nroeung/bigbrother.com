...
<div class="button-run">
  ...
  <td><button style="height:70px;width:170px" id="button2" type="button"><a href="http://10.10.53.80:3000/dashboard/db/at-hack-o-thon-monitor?refresh=5m&orgId=1&var-Group=apps&var-Server=10.10.53.81&var-MinStep=$__auto_interval">Realtime Infrastructure Monitoring</a></button></td>
